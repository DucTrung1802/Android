package com.application.app.modules.tips.`data`.model

import com.application.app.R
import com.application.app.appcomponents.di.MyApp
import kotlin.String

public data class TipsModel(
  /**
   ...
   * TODO Replace with dynamic value
   */
  public var txtCONTACTS: String? = MyApp.getInstance().resources.getString(R.string.lbl_contacts)
  ,
  /**
   * TODO Replace with dynamic value
   */
  public var txtTIPS: String? = MyApp.getInstance().resources.getString(R.string.lbl_tips)
  ,
  /**
   * TODO Replace with dynamic value
   */
